    ...
    <aside className="fixed left-0 top-0 z-40 hidden h-screen w-[250px] flex-col border-r border-[#E9E1E4] bg-white lg:flex">
      ...
      <div className="flex h-[82px] items-center px-7">
        <Link href="/dashboard" className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-[14px] bg-[#6D3A5B] text-white shadow-sm">
            ...
            return (
              <Link key={item.href} href={item.href}>
                <motion.div
                  ...
                  className={`relative flex h-11 items-center gap-3 rounded-[12px] px-3 text-[14px] font-medium transition-colors ${
                    isActive
      ...
      {/* Bottom section */}
      <div className="border-t border-[#E9E1E4] px-4 py-4">
        <Link href="/settings">
          <motion.div
            whileHover={{ x: 2 }}
            className={`flex h-11 items-center gap-3 rounded-[12px] px-3 text-[14px] font-medium transition-colors ${
        ...
        <div className="mt-4 rounded-[14px] bg-[#FBF8F7] p-3">
          <div className="flex items-center gap-2">
            <div className="h-2 w-2 rounded-full bg-[#4F8068]" />
